    ...
    return (
      <>
        <div className="pt-10 pb-6 px-3">
          <h1 className="flex flex-col text-3xl text-white leading-normal tracking-wider">
            关于
          </h1>
          
          <div className="mt-6 space-y-1">
            <h2 className="flex flex-col text-3xl text-slate-100 leading-normal tracking-wider">
                主要分享
            </h2>
          ...
          <div className="mt-6 space-y-1">
            ...
            <h3 className="flex flex-col text-2xl text-slate-100 leading-normal tracking-wider">
                为什么从教练那里购买比官网便宜
            </h3>
